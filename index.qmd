...
for (i in 1:6) {
  ...
  adf_[[i]] <- adf_result
  adf_diff_result = adf.test(diff(Y[,i]), k = max_lag) # include testing for the first differences and extend the code below to include this in reporting
...
knitr::kable(adf_table, digits = 3) # a nicer presentation of table in Quarto
