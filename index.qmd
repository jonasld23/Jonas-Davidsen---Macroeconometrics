...
* $SPX_t$: Log returns on SP500 from Yahoo Finance
...
rownames(adf_table)<- c("Money Supply", "SP500 Returns", "House Price Index", "Inflation","Effective Fed Funds Rate","Industrial Production")
